...
class UserHomeScreen extends StatelessWidget {
  ...
  AdminController adminController = Get.put(AdminController());  // Ensure AdminController is initialized
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: GetBuilder<AdminController>(  // Using GetBuilder to observe changes in categories
        builder: (controller) {
